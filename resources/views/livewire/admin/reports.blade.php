<section class="space-y-6">
    ...
    {{-- Report Content --}}
    @if($reportType === 'daily_census')
        @include('livewire.admin.reports.daily-census', ['data' => $reportData])
    @elseif($reportType === 'appointment_stats')
        @include('livewire.admin.reports.appointment-stats', ['data' => $reportData])
    @elseif($reportType === 'service_utilization')
        @include('livewire.admin.reports.service-utilization', ['data' => $reportData])
    @elseif($reportType === 'queue_performance')
        @include('livewire.admin.reports.queue-performance', ['data' => $reportData])
    @endif
</section>
